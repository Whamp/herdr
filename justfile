...
test:
    ...
    python3 -m unittest scripts.test_agent_detection_manifest_check scripts.test_changelog scripts.test_config_reference_check scripts.test_docs_translation_parity scripts.test_preview scripts.test_port_forward_distribution scripts.test_remote_link_platform_gate scripts.test_vendor_libghostty_vt scripts.test_vendor_portable_pty
