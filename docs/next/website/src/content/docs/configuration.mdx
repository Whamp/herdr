...
The device-local remote link experiment and its forwarding requirements, limits, cleanup, and recovery behavior are documented under [Open remote links on this device](/docs/persistence-remote/#open-remote-links-on-this-device).
